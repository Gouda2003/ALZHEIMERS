...
def image():
    if request.method == 'POST':
        ...
        IMG_SIZE = 50
        LR = 1e-3
        MODEL_NAME = 'Alzheimersdetection-{}-{}.model'.format(LR, '2conv-basic')
    ##    MODEL_NAME='keras_model.h5'
        ...
        for num, data in enumerate(verify_data):
            ...
            if np.argmax(model_out) == 0:
                ...
                rem = "The remedies for  MildDemented are:\n\n "
                rem1 = ["Cognitive Stimulation Activities",  
                "Healthy Diet", 
                "Regular Exercise", 
                ...
                print("The predicted image of the Moderate is with a accuracy of {} %".format(model_out[2]*100))
                accuracy="The predicted image of the Moderate is with a accuracy of {}%".format(model_out[2]*100)
                ...
                print("The predicted image of the Severe is with a accuracy of {} %".format(model_out[3]*100))
                accuracy="The predicted image of the Severe is with a accuracy of {}%".format(model_out[3]*100)
                rem = "The remedies for  VeryMildDemented are:\n\n "
                rem1 = ["Healthy Lifestyle Changes",  
            ...
            dic={'Mild':A,'Moderate':B,'NonDemented':C,'VeryMild':D}
            algm = list(dic.keys()) 
...
##            bot.sendMessage(chat_id, 'Hello from Python!')
